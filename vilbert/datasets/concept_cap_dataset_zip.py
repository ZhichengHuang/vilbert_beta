...
class ConceptCapDataset(Dataset):
    ...
    def process_item(self, caption,img):
        image_feature,image_target,image_location_ws,image_h,image_w= img['feature'][:self.region_len,:],img['label'][:self.region_len],img['box'][:self.region_len,:],img['width'],img['height']# w,h,w,h
